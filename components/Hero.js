...
const Hero = () => {
  ...
  return (
    <div className="flex h-screen flex-col lg:flex-row justify-center items-center" >
      <div className="flex flex-col md:w-4/5 mt-16 lg:-mr-24 ">
        ...
        <p className="mt-2 text-sm md:text-base font-normal leading-6 md:leading-7 tracking-wider opacity-60">
      ...
      <div className="mt-9 lg:w-11/12 h-2/6 md:h-auto scale-110 md:scale-105">
        <Lottie
